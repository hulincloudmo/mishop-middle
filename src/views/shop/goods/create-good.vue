<template>
    <div class="bg-white" style="margin: -20px;">
        ...
        <el-tabs style="padding-left: 20px" v-model="activeIndex">
            <el-tab-pane label="基础设置">
                <basic-setting :form="form" :options="options"></basic-setting>
            </el-tab-pane>
            <el-tab-pane label="商品规格">
                <!-- 规格选项 -->
                <el-form ref="sku_form"  label-width="80px">
                    <el-form-item label="商品规格">
                        <el-radio-group :value="sku_settings.skus_type" >
                            <el-radio-button label="0" @click="vModel('skus_type',0)">单一规格</el-radio-button>
                            <el-radio-button label="1">多规格</el-radio-button>
                        </el-radio-group>
                    </el-form-item>
                </el-form>
                <!-- 单规格 -->
                <template v-if="sku_settings.skus_type === 0">
                    <el-form ref="sku_form" label-width="80px">
...
<script>
    import basicSetting from "@/components/goods/create-good/basic-setting.vue"
    ...
    export default {
        ...
        computed:{
            ...mapState({
                sku_settings: state=>state.goodCreate.createGood
            }),
            ...mapGetters([
                'getSku'
            ])
